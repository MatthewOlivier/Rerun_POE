...
using System.IO;
    ...
    {
        public MeleeUnit(int x, int y, int Hp, int Spd, int Atk, int AtkRange, char Faction, char Symbol, string Name) : base (x,y,Hp,Spd, Atk, AtkRange, Faction, Symbol, Name )
        {
            this.X = x;
            this.Y = y;
            this.Hp1 = 100;
        ...
        {
            return ("I am" + Name1 + "I have the following stats" + Hp1 + Spd1 + Atk1 + AtkRng1 + "My and display symbol and faction is" + Symbol1 + Faction1 + "My cordinates are" + X + Y);
        }
